(function() {
    ...
    module.exports = function(from, files) {
        ...
        emitter = new Rummy(from, files);
        
        return emitter;
    };
    
    function Rummy(from, files) {
        var self            = this;
    ...
    Rummy.prototype._parallel  = function(from, files, callback) {
        var self    = this,
            i       = files.length,
            fn      = function() {
                if (!--i)
    ...
    Rummy.prototype.continue   = function() {
        this._pause = false;
        this._rmAll();
    };
    
    Rummy.prototype.pause      = function() {
        this._pause = true;
    };
    
    Rummy.prototype.abort      = function() {
        this._files = [];
        this._dirs  = [];
    ...
    Rummy.prototype._rmAll     = function() {
        var self    = this,
    ...
    Rummy.prototype._findFiles = function(filename, fn) {
        var self        = this,
    ...
    Rummy.prototype._rmOneFile = function(name) {
    ...
    Rummy.prototype._rmOneDir  = function(name) {
        var emitter     = new Emitter();
    ...
    Rummy.prototype._progress  = function() {
        var value;
    ...
    Rummy.prototype._normalize = function(dir, name) {
